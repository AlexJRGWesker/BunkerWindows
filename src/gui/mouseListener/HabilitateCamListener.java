...
import logic.tasksToDo.TasksToDo_Cam;
import logic.tasksToDo.TasksToDo_Micro;

public class HabilitateCamListener extends MouseAdapter{
	private Color defaultColor = Color.LIGHT_GRAY;
    private Color hoverColor = Color.GRAY;
    private JPanel jpanel;
    
    public HabilitateCamListener(JPanel jpanel) {
    	this.jpanel = jpanel;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        SwingWorker<ArrayList<String>, Void> worker = new SwingWorker<ArrayList<String>, Void>() {
            ...
            protected ArrayList<String> doInBackground() throws Exception {
            	...
            	TasksToDo_Cam tasksToDo_Cam = new TasksToDo_Cam();
                return tasksToDo_Cam.tasksToDo_Cam("Habilitate");
            }
            ...
            protected void done() {
                try {
                    ...
                    JProgressBarTasks progressBarTasks = new JProgressBarTasks(tasks,"Cam");
