...
public class DeshabilitateMicroListener extends MouseAdapter{
	private Color defaultColor = Color.LIGHT_GRAY;
    private Color hoverColor = Color.GRAY;
    private JPanel jpanel;
    
    public DeshabilitateMicroListener(JPanel jpanel) {
    	this.jpanel = jpanel;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        SwingWorker<ArrayList<String>, Void> worker = new SwingWorker<ArrayList<String>, Void>() {
            ...
            protected ArrayList<String> doInBackground() throws Exception {
                ...
                TasksToDo_Micro tasksToDo_Micro = new TasksToDo_Micro();
                return tasksToDo_Micro.tasksToDo_Micro("Deshabilitate");
            }
            ...
            protected void done() {
                try {
                    ...
                    JProgressBarTasks progressBarTasks = new JProgressBarTasks(tasks,"Micro");
