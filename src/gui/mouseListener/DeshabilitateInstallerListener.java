...
import logic.tasksToDo.TasksToDo_Installer;

public class DeshabilitateInstallerListener extends MouseAdapter{
	private Color defaultColor = Color.LIGHT_GRAY;
    private Color hoverColor = Color.GRAY;
    private JPanel jpanel;
    
    public DeshabilitateInstallerListener(JPanel jpanel) {
    	this.jpanel = jpanel;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        SwingWorker<ArrayList<String>, Void> worker = new SwingWorker<ArrayList<String>, Void>() {
            ...
            protected ArrayList<String> doInBackground() throws Exception {
            	...
            	TasksToDo_Installer tasksToDo_Installer = new TasksToDo_Installer();
                return tasksToDo_Installer.tasksToDo_Installer("Deshabilitate");
            }
            ...
            protected void done() {
                try {
                    ...
                    JProgressBarTasks progressBarTasks = new JProgressBarTasks(tasks,"Installer");
