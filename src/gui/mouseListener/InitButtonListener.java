...
public class InitButtonListener extends MouseAdapter{
	private Color defaultColor = Color.LIGHT_GRAY;
    private Color hoverColor = Color.GRAY;
    private JPanel jpanel;
    
    public InitButtonListener(JPanel jpanel) {
    	this.jpanel = jpanel;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        SwingWorker<ArrayList<String>, Void> worker = new SwingWorker<ArrayList<String>, Void>() {
            ...
            protected ArrayList<String> doInBackground() throws Exception {
                ...
                return tasksToDo_Bunker.tasksToDo_Bunker();
            }
            ...
            protected void done() {
                try {
                    ...
                    JProgressBarTasks progressBarTasks = new JProgressBarTasks(tasks,"Bunker");
