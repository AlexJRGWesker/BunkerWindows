...
public class RestoreButtonListener extends MouseAdapter{
	private Color defaultColor = Color.LIGHT_GRAY;
    private Color hoverColor = Color.GRAY;
    private JPanel jpanel;
    
    public RestoreButtonListener(JPanel jpanel) {
    	this.jpanel = jpanel;
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        SwingWorker<ArrayList<String>, Void> worker = new SwingWorker<ArrayList<String>, Void>() {
            ...
            protected ArrayList<String> doInBackground() throws Exception {
                ...
                return tasksToDo_Restore.tasksToDo_Restore();
            }
            ...
            protected void done() {
                try {
                    ...
                    JProgressBarTasks progressBarTasks = new JProgressBarTasks(tasks,"Restore");
